...
f=open('responses.txt','r',errors = 'ignore')
...
Introduce_Ans = ["My name is LAMPBot.","My name is LAMPBot you can called me Lamp.","Im LAMPBot :) ","My name is LAMPBot. and my nickname is Lamp and I am happy to solve your queries :) "]
