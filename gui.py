...
# Menu bar
    ...
    # Options
        ...
        help_option.add_command(label="About LAMPBot", command=self.msg)
    ...
    def msg(self):
        tkinter.messagebox.showinfo("LAMPBot v1.0",'LAMPBot is a chatbot for answering student queries and concerns\n')

    def about(self):
        tkinter.messagebox.showinfo("LAMPBot Developers","1.Adrian Arboleda\n2.Grand Vince Lainez\n3.Alexis John Gonzales\n4.Louise Joy Magtaas\n5.Froilan Amac")
